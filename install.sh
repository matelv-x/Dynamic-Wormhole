...
PATCH_FILE="$SCRIPT_DIR/dynamic-wormhole.patch"
BACKUP_ROOT="${BACKUP_ROOT:-/home/pi}"
STAMP="$(date +%Y%m%d_%H%M%S)"
BACKUP_DIR="$BACKUP_ROOT/sg1_v4_backup_dynamic_wormhole_$STAMP"
...
log "Done"
echo "Installed dynamic-wormhole patch into: $TARGET"
